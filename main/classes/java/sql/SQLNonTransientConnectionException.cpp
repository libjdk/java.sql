...
SQLNonTransientConnectionException::SQLNonTransientConnectionException(const SQLNonTransientConnectionException& e) {
}

SQLNonTransientConnectionException SQLNonTransientConnectionException::wrapper$() {
	$pendingException(this);
	return *this;
}

void SQLNonTransientConnectionException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
