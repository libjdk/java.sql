...
SQLRecoverableException::SQLRecoverableException(const SQLRecoverableException& e) {
}

SQLRecoverableException SQLRecoverableException::wrapper$() {
	$pendingException(this);
	return *this;
}

void SQLRecoverableException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
